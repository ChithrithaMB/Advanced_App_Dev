        ...
        <table className="w-full">
          <thead>
            <tr className="bg-indigo-500 text-white">
              <th className="px-4 py-2">PaymentID</th>
              <th className="px-4 py-2">UserID</th>
              <th className="px-4 py-2">Status</th>
              <th className="px-4 py-2">TotalAmount</th>
              <th className="px-4 py-2">PaymentDate</th>
              <th className="px-4 py-2">ModeofPayment</th>
            </tr>
          </thead>
          <tbody>
            {orders.map((order, index) => (
              <tr key={index} className={index % 2 === 0 ? "bg-gray-100 hover:bg-indigo-200" : "bg-gray-200 hover:bg-gray-300"}>
